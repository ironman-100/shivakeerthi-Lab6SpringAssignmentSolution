...
import com.collegefestspringmvc.service.StudentFestUserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public UserDetailsService userDetailsService() {
		return new StudentFestUserDetailsServiceImpl();
	}
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/login").permitAll()
				...
				.antMatchers(HttpMethod.GET, "/student/list", "/student/add").hasAnyAuthority("USER", "ADMIN")
				.antMatchers(HttpMethod.PUT, "/student/update").hasAuthority("ADMIN")
				.antMatchers(HttpMethod.DELETE, "/student/delete/*").hasAuthority("ADMIN")
